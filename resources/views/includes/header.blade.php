    ...
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
                ...
                <!-- <div class="min-h-screen bg-white dark:bg-gray-800 dark:text-gray-100"> -->
                    <!-- <div class="flex items-center justify-center space-x-2"> -->
                            ...
                            <label for="toggle" class="flex items-center h-5 p-1 duration-300 ease-in-out bg-gray-300 rounded-full cursor-pointer w-9 dark:bg-gray-600">
                                <div class="w-4 h-4 duration-300 ease-in-out transform bg-white rounded-full shadow-md toggle-dot dark:translate-x-3">
                                </div>
                            </label>
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <li x-data="{ isOpen: false }" class="relative">
                <div class="flex flex-col items-center justify-center align-middle rounded-full focus:shadow-outline-purple focus:outline-none" @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
                    <img class="object-cover w-8 h-8 rounded-full" src="{{asset('images/Account photo.jpeg')}}" alt="" aria-hidden="true" />
                    <span> Admin</span>
                </div>
