    ...
    <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
        <nav aria-label="Table navigation">
            <ul class="inline-flex items-center">
                ...
                -->
                {{-- Previous Page Link --}}
                <!-- Test for the first page to diactivte it -->
                @if ($paginator->onFirstPage())
                <li>
                ...
                @endif
                <!-- End of Test for the first page to diactivte it -->
                {{-- Pagination Elements --}}
                ...
                {{-- Next Page Link --}}
                <!-- Test for the Last page to diactivte that icon of next -->
                @if ($paginator->hasMorePages())
                <li>
                    <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple" aria-label="{{ __('pagination.next') }}">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li>
                    <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                        <span class="px-3 py-1 rounded-md focus:outline-none focus:shadow-outline-purple" aria-hidden="true">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                            </svg>
                        </span>
                ...
                @endif
                <!-- END of Test for the Last page to diactivte icon next -->
                <!-- <li>
