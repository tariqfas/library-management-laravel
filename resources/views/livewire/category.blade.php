<div>
    ...
    <a class="flex items-center justify-between p-4 mb-8 my-3 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
        <div class="flex items-center">
            <span>{{__('Category ')}}{{"($nbrCategories)"}}</span>
        </div>
        <span>
    ...
    <form action="" wire:submit.prevent="store">
        ...
        <button type="reset"  class="px-4 py-2 my-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-red-600 border border-transparent rounded-lg active:bg-red-600 hover:bg-red-700 focus:outline-none focus:shadow-outline-purple" 
            wire:click="cancel"
        >
            Cancel
        </button>
    ...
    <form action="">
        ...
        <button class="px-4 py-2 my-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
            wire:click="updateCategory({{$updatedCategoryId}})"
        >
            Edit
        </button>
