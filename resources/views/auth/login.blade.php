...
<body>
    ...
    <div class="contain py-16 ">
        <div class="max-w-lg mx-auto bg-gray-100 shadow px-6 py-7 rounded overflow-hidden">
            @if($errors->has('message'))
            <div class="alert alert-danger">
                {{ $errors->first('message') }}
            </div>
            @endif
            <div class="text-2xl font-medium mb-1 text-center ">
                <!-- <div class="svgContainer w-10 h-10 rounded border">
                    <div class="overflow-hidden rounded w-full h-0 p-10">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        <label id="showPasswordToggle" for="showPasswordCheck">Show
                            ...
                            <div class="indicator text-gray-600 ml-3 cursor-pointer"></div>
                        </label>
                    </div>
                </div>
                <div class="mt-4">
