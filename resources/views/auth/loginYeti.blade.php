...
<head>
    <meta charset="UTF-8">
    <title>CodePen - yeti login</title>
    ...
    <style>
        ...
        form .svgContainer:after {
            ...
            height: inherit;
            box-sizing: border-box;
            border: solid 2.5px rgb(147 51 234);
            border-radius: 50%;
        }
        ...
        form input[type=password] {
            ...
            border: solid 2px rgb(147 51 234);
            border-radius: 4px;
        ...
        form input[type=password]:focus {
            ...
            border: solid 2px rgb(126 34 206);
        }
...
<body>
    ...
    <form>
        <div class="svgContainer relative w-[200px] h-[200px]">
            <div class="rounded-full w-full  overflow-hidden pb-[100%]">
                <svg class="mySVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 200 200">
                    ...
                    <circle cx="100" cy="100" r="100" fill="rgb(147 51 234)" />
                    <g class="body">
                        ...
                        <path fill="rgb(192 132 252)" d="M100,156.4c-22.9,0-43,11.1-54.1,27.7c15.6,10,34.2,15.9,54.1,15.9s38.5-5.8,54.1-15.9 C143,167.5,122.9,156.4,100,156.4z" />
                    </g>
                    <g class="earL">
                        <g class="outerEar" fill="rgb(192 132 252)" stroke="#3a5e77" stroke-width="2.5">
                    ...
                    <g class="earR">
                        <g class="outerEar">
                            <circle fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" cx="153" cy="83" r="11.5" />
                            <path fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" d="M153.7,78.9 c2.3,0,4.1,1.9,4.1,4.1c0,2.3-1.9,4.1-4.1,4.1" />
                        </g>
                        <g class="earHair">
                    ...
                    <path class="face" fill="rgb(192 132 252)" d="M134.5,46v35.5c0,21.815-15.446,39.5-34.5,39.5s-34.5-17.685-34.5-39.5V46" />
                    ...
                    <g class="arms" clip-path="url(#armMask)">
                        <g class="armL" style="visibility: hidden;">
                            <polygon fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="121.3,98.4 111,59.7 149.8,49.3 169.8,85.4" />
                            <path fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M134.4,53.5l19.3-5.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-10.3,2.8" />
                            <path fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M150.9,59.4l26-7c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-21.3,5.7" />

                            <g class="twoFingers">
                                <path fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M158.3,67.8l23.1-6.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-23.1,6.2" />
                                <path fill="rgb(147 51 234)" d="M180.1,65l2.2-0.6c1.1-0.3,2.2,0.3,2.4,1.4v0c0.3,1.1-0.3,2.2-1.4,2.4l-2.2,0.6L180.1,65z" />
                                <path fill="rgb(192 132 252)" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M160.8,77.5l19.4-5.2c2.7-0.7,5.4,0.9,6.1,3.5v0c0.7,2.7-0.9,5.4-3.5,6.1l-18.3,4.9" />
                                <path fill="rgb(147 51 234)" d="M178.8,75.7l2.2-0.6c1.1-0.3,2.2,0.3,2.4,1.4v0c0.3,1.1-0.3,2.2-1.4,2.4l-2.2,0.6L178.8,75.7z" />
                            </g>
                            <path fill="rgb(147 51 234)" d="M175.5,55.9l2.2-0.6c1.1-0.3,2.2,0.3,2.4,1.4v0c0.3,1.1-0.3,2.2-1.4,2.4l-2.2,0.6L175.5,55.9z" />
                            <path fill="rgb(147 51 234)" d="M152.1,50.4l2.2-0.6c1.1-0.3,2.2,0.3,2.4,1.4v0c0.3,1.1-0.3,2.2-1.4,2.4l-2.2,0.6L152.1,50.4z" />
                        ...
                        <g class="armR" style="visibility: hidden;">
                            <path fill="rgb(192 132 252)" stroke="#3a5e77" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2.5" d="M265.4 97.3l10.4-38.6-38.9-10.5-20 36.1z" />
                            <path fill="rgb(192 132 252)" stroke="#3a5e77" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="2.5" d="M252.4 52.4L233 47.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l10.3 2.8M226 76.4l-19.4-5.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l18.3 4.9M228.4 66.7l-23.1-6.2c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l23.1 6.2M235.8 58.3l-26-7c-2.7-.7-5.4.9-6.1 3.5-.7 2.7.9 5.4 3.5 6.1l21.3 5.7" />
                            <path fill="rgb(147 51 234)" d="M207.9 74.7l-2.2-.6c-1.1-.3-2.2.3-2.4 1.4-.3 1.1.3 2.2 1.4 2.4l2.2.6 1-3.8zM206.7 64l-2.2-.6c-1.1-.3-2.2.3-2.4 1.4-.3 1.1.3 2.2 1.4 2.4l2.2.6 1-3.8zM211.2 54.8l-2.2-.6c-1.1-.3-2.2.3-2.4 1.4-.3 1.1.3 2.2 1.4 2.4l2.2.6 1-3.8zM234.6 49.4l-2.2-.6c-1.1-.3-2.2.3-2.4 1.4-.3 1.1.3 2.2 1.4 2.4l2.2.6 1-3.8z" />
        ...
        <div class="inputGroup inputGroup3">
            <button class="block w-full py-2 text-center text-white bg-purple-600 border border-primary rounded hover:bg-purple-700 transition uppercase font-roboto font-medium" id="login">Log in</button>
        </div>
    </form>
    <!-- partial -->
